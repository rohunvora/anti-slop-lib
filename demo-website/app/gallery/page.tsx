        ...
        <div className="space-y-4">
          {filteredWebsites.map((site) => (
            <Link 
              key={site.slug}
              href={`/site/${site.slug}`}
              className="group block border-3 border-ink bg-paper-bright hover:bg-paper transition-colors"
            >
              <div className="grid lg:grid-cols-[280px,1fr] items-stretch">
                {/* Thumbnail */}
                ...
                <div className="p-6 flex flex-col justify-between">
                  <div>
                    <div className="flex items-start justify-between gap-4 mb-3">
                      <div>
                        ...
                        <h2 className="font-display text-xl lg:text-2xl group-hover:text-vermilion transition-colors">
                          {site.name}
                        </h2>
                      </div>
                      <span className="font-mono text-sm text-vermilion opacity-0 group-hover:opacity-100 transition-opacity">
                        View analysis →
                      </span>
                    </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {site.fonts.length > 0 && (
                      <span className="tag tag-teal text-[10px]">
                        {site.fonts[0]}
                      </span>
                    )}
                  </div>
